      ...
      <div class="flex flex-col w-full bg-surface">
        ...
        <section class="w-full max-w-[1360px] mx-auto px-gutter-mobile md:px-gutter-desktop py-10 md:py-16" id="how-it-works">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
            ...
            <!-- Owner Steps -->
            <div class="p-6 bg-surface-container-lowest rounded-xl border border-outline space-y-4 flex flex-col justify-between">
              <div class="space-y-4">
              ...
              <div class="pt-4 border-t border-outline">
                <button onclick="Modals.openAddHallWizard()" class="w-full py-2.5 bg-secondary hover:bg-secondary-container text-white font-bold text-xs uppercase tracking-wider rounded-lg shadow-sm transition-all flex items-center justify-center gap-2">
                  <span class="material-symbols-outlined text-[18px]">add_business</span>
                  <span>Start Listing Your Hall</span>
                </button>
              </div>
            </div>
